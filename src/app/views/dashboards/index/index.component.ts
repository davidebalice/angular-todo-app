...
// Data Get
import { activityData, problemsData, userReviewData } from './index.data';
import { activityModel, problemsModel, userReviewModel } from './index.model';

@Component({
  selector: 'app-index',
  standalone: true,
  imports: [CommonModule, RouterLink, NgApexchartsModule, HttpClientModule],
...
export class IndexComponent {
  ...
  // Latest Activity
  problemsData!: problemsModel[];
  // Swiper Slider
  @ViewChild('userReview', { static: false }) userReview:
    | ElementRef
    | undefined;
  ...
  public chartSummary: Partial<ChartOptions>;
  public serverstatus: Partial<ChartOptions>;
